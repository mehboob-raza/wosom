    ...
    <Box mt={3}>
      <Box>
        ...
        <Box sx={{
          ...
          {!video ?
            <img height={136} width={223} onClick={() => hiddenFileInput.current!.click()} src={"../../../../../src/assets/VideoUpload.svg"} alt='cards' style={{ cursor: 'pointer', }} /> :
            <video height={136} width={223} controls={true} src={URL.createObjectURL(video)} />
          }
        </Box>
